<template>
  <div class="header" :class="{commonClass:isConmonStyle}">
    <div class="header_box">
      ...
      <!-- 个人、企业会员 -->
      <div class="header_login" @mouseover="showHeader_personNav" @mouseout="hideHeader_personNav" v-if="getLoginSuccess">
        <!-- <span v-if="false" class="header_login_personal">个人会员</span>
        <span v-if="false" class="header_login_company">企业会员</span> -->
        <div  class="header_loginState">
...
export default {
  ...
  methods: {
    ...
    outLogin: function () {
      this.$store.commit('newVisitor', this.visitorMsgHomgOut)
